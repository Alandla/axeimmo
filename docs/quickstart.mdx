...
response = requests.get(
    'https://api.hoox.video/v1/resources/voices',
...
```bash cURL
curl -X GET "https://api.hoox.video/v1/resources/avatars?tags=business" \
  -H "Authorization: Bearer your_api_key"
```

```python Python
response = requests.get(
    'https://api.hoox.video/v1/resources/avatars',
    headers={'Authorization': 'Bearer your_api_key'},
...
const avatarResponse = await fetch(
  'https://api.hoox.video/v1/resources/avatars?tags=business',
  {
    headers: {
      'Authorization': 'Bearer your_api_key'
    }
...
```javascript Node.js
// Direct video generation from prompt
const generationResponse = await fetch('https://api.hoox.video/v1/generation/start', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer your_api_key',
    'Content-Type': 'application/json'
...
script_response = requests.post(
    'https://api.hoox.video/v1/script/generate',
    headers={
        'Authorization': 'Bearer your_api_key',
        'Content-Type': 'application/json'
    },
...
const scriptResponse = await fetch('https://api.hoox.video/v1/script/generate', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer your_api_key',
    'Content-Type': 'application/json'
...
const videoResponse = await fetch('https://api.hoox.video/v1/generation/start', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer your_api_key',
    'Content-Type': 'application/json'
...
def export_and_download_video(video_id, format="vertical"):
    ...
    while True:
        export_status_response = requests.get(
            f'https://api.hoox.video/v1/export/status/{export_job_id}',
            headers={'Authorization': 'Bearer your_api_key'}
        )
...
async function exportAndDownloadVideo(videoId, format = "vertical") {
  ...
  while (true) {
    const exportStatusResponse = await fetch(
      `https://api.hoox.video/v1/export/status/${exportJobId}`,
      {
        headers: {
          'Authorization': 'Bearer your_api_key'
        }
