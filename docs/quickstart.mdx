...
For better control, generate a script first:
...
<Info>
**Free Export for API Videos**: Videos created through the API have export costs included in the generation price, so export first export is free.
</Info>
...
<AccordionGroup>
  ...
  <Accordion title="Optimize Export Strategy">
    ...
    - Download videos immediately - URLs expire after 7 days
  </Accordion>
</AccordionGroup>
