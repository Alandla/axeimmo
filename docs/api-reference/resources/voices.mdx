...
api: "GET https://app.hoox.video/api/public/v1/resources/voices"
...
url = "https://app.hoox.video/api/public/v1/resources/voices"
headers = {
...
const filteredResponse = await fetch(
  'https://app.hoox.video/api/public/v1/resources/voices?language=en&gender=female&tags=professional',
  {
    headers: {
      'Authorization': 'Bearer your_api_key'
    }
