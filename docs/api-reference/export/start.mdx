...
Export costs depend on how the video was created and which avatar model you choose:
...
<Info>
Avatar costs are charged separately from base export costs. Total cost = Base export cost + Avatar cost.
</Info>

**Example**: A 60-second video with 40 seconds of avatar visibility using the Premium model:
