...
export const SubtitlesModern = ({ subtitleSequences, style, videoFormat, customHeight, onStyleChange, onPlayPause }: { subtitleSequences: any, style: any, videoFormat?: VideoFormat, customHeight?: number, onStyleChange?: (newStyle: any) => void, onPlayPause?: () => void }) => {
			...
			{subtitles.map((subtitle, index) => {
				...
				const element = (
					<Sequence key={index} from={currentFrame} durationInFrames={subtitle.durationInFrames}>
						<SubtitleModern subtitleSequence={subtitle} start={currentFrame} style={style} videoFormat={videoFormat} customHeight={customHeight} onPositionChange={handlePositionChange} onPlayPause={onPlayPause} />
					</Sequence>
				);
